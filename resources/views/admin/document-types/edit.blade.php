...
@section('title', 'Edit Jenis Dokumen — SIMARS-DOC')
...
<div class="max-w-xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Jenis Dokumen</h1>
            <p class="text-sm text-gray-500 mt-0.5">Perbarui kode atau nama jenis dokumen.</p>
        </div>
